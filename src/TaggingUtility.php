 ...
 *
 * @author Emre Sarıoğlu <emresarioglu89@gmail.com>
 * @copyright Copyright (C) 2021 Emre Sarıoğlu
 */
class TaggingUtility
{
    ...
    public static function normalize($string)
    {
        ...
        if(is_string($normalizer) && Str::contains($normalizer, 'Emresari\Tagging\Util')) {
            $normalizer = '\Emresari\Tagging\TaggingUtility::slug';
        }
    ...
    {
        return config('tagging.tag_model', '\Emresari\Tagging\Model\Tag');
    }
    ...
    {
        return config('tagging.tagged_model', '\Emresari\Tagging\Model\Tagged');
    }
    ...
    {
        return config('tagging.tag_group_model', '\Emresari\Tagging\Model\TagGroup');
    }
}
